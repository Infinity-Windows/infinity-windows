...
export const CATALOG = {
  ...
  "crewRecord.help": { en: "File work for others, even when they never started a unit timer. Select an existing unit or build one here.", es: "Registra trabajo de otros, incluso sin temporizador. Selecciona una unidad existente o crea una aquí." },
  "crewRecord.job": { en: "Job", es: "Trabajo" },
  "crewRecord.chooseJob": { en: "Choose job", es: "Elegir trabajo" },
  "crewRecord.unit": { en: "Unit", es: "Unidad" },
  "crewRecord.chooseUnit": { en: "Choose unit", es: "Elegir unidad" },
  "crewRecord.newUnit": { en: "+ Build a new unit", es: "+ Crear unidad" },
  "crewRecord.mapUnit": { en: "Map unit", es: "Unidad del plano" },
  "crewRecord.useUnit": { en: "Use this unit", es: "Usar esta unidad" },
  "crewRecord.buildUnit": { en: "Build unit details", es: "Crear detalles de unidad" },
  "crewRecord.unitDetails": { en: "Build unit for crew", es: "Crear unidad para el equipo" },
  "crewRecord.continue": { en: "Continue to crew & work date", es: "Continuar a equipo y fecha" },
  "crewRecord.close": { en: "Close", es: "Cerrar" },
  "crewRecord.identify": { en: "Choose a job and enter a unit number or name.", es: "Elige un trabajo e ingresa el nombre o número de unidad." },
  "crewRecord.duplicate": { en: "This unit already exists. Choose it from the list, or include the floor/building if it is a different unit.", es: "Esta unidad ya existe. Elígela de la lista o agrega el piso/edificio si es otra unidad." },
  "crewRecord.changeUnit": { en: "Change unit", es: "Cambiar unidad" },
  "crewRecord.date": { en: "Work / assignment date", es: "Fecha de trabajo / asignación" },
  "crewRecord.stage": { en: "Work stage", es: "Etapa del trabajo" },
  "crewRecord.status": { en: "Work status", es: "Estado del trabajo" },
  "crewRecord.finished": { en: "Stage completed", es: "Etapa terminada" },
  "crewRecord.partial": { en: "Partially completed", es: "Parcialmente terminado" },
  "crewRecord.assigned": { en: "Assigned — not done yet", es: "Asignado — aún no terminado" },
  "crewRecord.people": { en: "Who did / will do the work?", es: "¿Quién hizo / hará el trabajo?" },
  "crewRecord.search": { en: "Search crew", es: "Buscar equipo" },
  "crewRecord.selected": { en: "{count} selected", es: "{count} seleccionados" },
  "crewRecord.notes": { en: "Work completed / instructions", es: "Trabajo terminado / instrucciones" },
  "crewRecord.noTime": { en: "This record does not add payroll hours, start timers or approve QC.", es: "Este registro no agrega horas de nómina, inicia temporizadores ni aprueba calidad." },
  "crewRecord.saving": { en: "Saving…", es: "Guardando…" },
  "crewRecord.save": { en: "Save crew record", es: "Guardar registro del equipo" },
  "crewRecord.saved": { en: "Saved on this device. See the crew records and sync status below for confirmation.", es: "Guardado en este dispositivo. Consulta los registros y el estado de sincronización para confirmar." },
  "crewRecord.history": { en: "Crew assignments & filed work", es: "Asignaciones y trabajo registrado" },
  "crewRecord.loading": { en: "Loading crew records…", es: "Cargando registros…" },
  "crewRecord.empty": { en: "No crew records filed yet.", es: "Aún no hay registros del equipo." },
  "crewRecord.pending": { en: "Saved on this device — awaiting sync", es: "Guardado en este dispositivo — pendiente de sincronizar" },
  "crewRecord.formerWorker": { en: "Former crew member", es: "Exmiembro del equipo" },
  "crewRecord.filed": { en: "Filed by {name} · {date}", es: "Registrado por {name} · {date}" },
  ...
  "timereport.customRange": { en: "Custom range", es: "Rango personalizado" },
  "timereport.fromDate": { en: "From date", es: "Fecha inicial" },
  "timereport.throughDate": { en: "Through date", es: "Fecha final" },
  "timereport.customRangeHelp": { en: "Includes both dates, based on each shift’s start day in your device’s time zone. Applies to the hours report below.", es: "Incluye ambas fechas según el día de inicio del turno en la zona horaria de tu dispositivo. Se aplica al informe de horas de abajo." },
  "timereport.rangeError.missing": { en: "Choose both dates to see hours.", es: "Elige ambas fechas para ver las horas." },
  "timereport.rangeError.invalid": { en: "Enter valid start and end dates.", es: "Ingresa fechas de inicio y fin válidas." },
  "timereport.rangeError.order": { en: "The through date must be on or after the from date.", es: "La fecha final debe ser igual o posterior a la fecha inicial." },
  "timereport.chooseJobs": { en: "Choose jobs", es: "Elegir trabajos" },
  "timereport.allJobs": { en: "All jobs", es: "Todos los trabajos" },
  "timereport.selectedJobs": { en: "Selected: {n}", es: "Seleccionados: {n}" },
  "timereport.clearJobs": { en: "Clear selection", es: "Quitar selección" },
  "timereport.searchJobs": { en: "Search jobs", es: "Buscar trabajos" },
  "timereport.noMatchingJobs": { en: "No matching jobs.", es: "No hay trabajos que coincidan." },
  "timereport.noJobsSelected": { en: "No jobs selected. Choose one or more jobs above to see their hours.", es: "No hay trabajos seleccionados. Elige uno o más trabajos arriba para ver sus horas." },
  "timereport.jobSelectionHelp": { en: "Select any combination of jobs. Clear selection to start with just the jobs you want. Searching keeps your selections.", es: "Selecciona cualquier combinación de trabajos. Quita la selección para empezar con los que quieras. La búsqueda conserva tus selecciones." },
  ...
  "timereport.finishedOnly": { en: "Finished hours, after breaks.", es: "Horas terminadas, después de descontar descansos." },
  ...
  "timereport.historyHelp": { en: "Finished jobs keep their hours in Job history. Open a job to finish or reopen it.", es: "Los trabajos terminados conservan sus horas en el historial. Abre un trabajo para terminarlo o reabrirlo." },
  ...
  "unassigned.count": { en: "{entries} entries · {people} people", es: "{entries} registros · {people} personas" },
  "unassigned.person": { en: "Crew member", es: "Integrante del equipo" },
  "unassigned.needsFinish": { en: "Needs finish time", es: "Falta hora de salida" },
  "unassigned.removed": { en: "Removed", es: "Eliminado" },
  "unassigned.needsReview": { en: "Needs review", es: "Requiere revisión" },
  "unassigned.netHours": { en: "after breaks", es: "después de descansos" },
  "unassigned.running": { en: "unfinished entry", es: "registro sin terminar" },
  "unassigned.workDay": { en: "Work day", es: "Día trabajado" },
  "unassigned.timeEntry": { en: "Clock in / out", es: "Entrada / salida" },
  "unassigned.noFinish": { en: "No clock-out", es: "Sin salida" },
  "unassigned.break": { en: "Break (h:mm)", es: "Descanso (h:mm)" },
  "unassigned.costCode": { en: "Cost code", es: "Código de costo" },
  "unassigned.reportedJob": { en: "Job named on the imported report: {job}", es: "Trabajo indicado en el reporte importado: {job}" },
  "unassigned.noDescription": { en: "No description added.", es: "Sin descripción." },
  "unassigned.added": { en: "Added {date}", es: "Registrado el {date}" },
  "unassigned.close": { en: "Close editor", es: "Cerrar editor" },
  "unassigned.assign": { en: "Assign job / edit", es: "Asignar trabajo / editar" },
  "unassigned.more": { en: "Show {count} more entries", es: "Mostrar {count} registros más" },
  ...
  "photo.checkingUploads": { en: "Checking photo upload status…", es: "Comprobando el estado de las fotos…" },
  "photo.uploadedOne": { en: "1 photo uploaded to job", es: "1 foto subida al trabajo" },
  "photo.uploadedMany": { en: "{n} photos uploaded to job", es: "{n} fotos subidas al trabajo" },
  "photo.waitingOne": { en: "1 photo waiting to upload", es: "1 foto pendiente de subir" },
  "photo.waitingMany": { en: "{n} photos waiting to upload", es: "{n} fotos pendientes de subir" },
  "photo.waitingHint": { en: "Saved on this device. Uploading when connected — you can keep working.", es: "Guardadas en este dispositivo. Se subirán cuando haya conexión; puedes seguir trabajando." },
  "photo.uploadUnconfirmed": { en: "An upload could not be confirmed. Check the job photos or saved entries.", es: "No se pudo confirmar una foto. Revisa las fotos del trabajo o los registros guardados." },
  "photo.viewJobPhotos": { en: "View job photos", es: "Ver fotos del trabajo" },
  ...
  "dictation.timeout": { en: "The connection took too long. Listen to or download your recording, then retry when the signal improves.", es: "La conexión tardó demasiado. Escucha o descarga tu grabación y reintenta cuando mejore la señal." },
  "dictation.recordingFailed": { en: "The microphone did not capture usable audio. Check microphone access and try again.", es: "El micrófono no capturó audio utilizable. Revisa el acceso al micrófono e intenta de nuevo." },
  "dictation.playback": { en: "Listen to your recording", es: "Escuchar tu grabación" },
  "dictation.download": { en: "Save audio", es: "Guardar audio" },
  "dictation.start": { en: "Dictate", es: "Dictar" },
  "dictation.stop": { en: "Stop & transcribe", es: "Detener y transcribir" },
  "dictation.cancel": { en: "Cancel recording", es: "Cancelar grabación" },
  "dictation.starting": { en: "Opening microphone…", es: "Abriendo micrófono…" },
  "dictation.transcribing": { en: "Transcribing…", es: "Transcribiendo…" },
  "dictation.retry": { en: "Retry transcription", es: "Reintentar transcripción" },
  "dictation.added": { en: "Words added. Review them before saving.", es: "Texto agregado. Revísalo antes de guardar." },
  "dictation.permission": { en: "Allow microphone access in your browser settings, then try again.", es: "Permite el acceso al micrófono en tu navegador y vuelve a intentar." },
  "dictation.unsupported": { en: "Use your keyboard’s microphone on this device. You can still type here.", es: "Usa el micrófono del teclado en este dispositivo. También puedes escribir aquí." },
  "dictation.offline": { en: "Your recording is ready here. Connect to the internet and tap Retry transcription.", es: "Tu grabación está lista aquí. Conéctate a internet y toca Reintentar transcripción." },
  "dictation.failed": { en: "Transcription did not finish. Your recording is kept here until you retry or close this form.", es: "No se completó la transcripción. Tu grabación se conserva aquí hasta que reintentes o cierres el formulario." },
  "dictation.empty": { en: "No words were detected. Try recording again.", es: "No se detectaron palabras. Intenta grabar de nuevo." },
  "dictation.limit": { en: "Dictation is temporarily at its limit. You can still type or use your keyboard’s microphone.", es: "El dictado llegó a su límite temporal. Puedes escribir o usar el micrófono del teclado." },
  "dictation.otherField": { en: "Finish the recording in the other field first.", es: "Primero termina la grabación en el otro campo." },
  "dictation.clipSize": { en: "Record a shorter message and try again.", es: "Graba un mensaje más corto y vuelve a intentar." },
  "dictation.tooMuchText": { en: "These words exceed this field’s limit. Your existing text is unchanged; copy the parts you need below.", es: "Estas palabras superan el límite del campo. Tu texto no cambió; copia las partes que necesites de abajo." },
  ...
  "timeOff.title": { en: "My time off", es: "Mis días libres" },
  "timeOff.teamTitle": { en: "Crew time off", es: "Días libres del equipo" },
  "timeOff.subtitle": { en: "Sick days, vacations and days off. Days only — payroll hours stay unchanged.", es: "Enfermedad, vacaciones y días libres. Solo días; las horas de nómina no cambian." },
  "timeOff.sickToday": { en: "Sick today", es: "Enfermo hoy" },
  "timeOff.add": { en: "Add time off", es: "Agregar días libres" },
  "timeOff.type": { en: "Reason", es: "Motivo" },
  "timeOff.kind.sick": { en: "Sick", es: "Enfermedad" },
  "timeOff.kind.vacation": { en: "Vacation", es: "Vacaciones" },
  "timeOff.kind.other": { en: "Other day off", es: "Otro día libre" },
  "timeOff.start": { en: "First day", es: "Primer día" },
  "timeOff.end": { en: "Last day", es: "Último día" },
  "timeOff.close": { en: "Close time-off form", es: "Cerrar formulario" },
  "timeOff.calendarDays": { en: "{n} calendar days, including weekends. Choose only the dates you need off.", es: "{n} días calendario, incluidos fines de semana. Elige solo las fechas que necesitas libres." },
  "timeOff.sickHelp": { en: "Sick days take effect as soon as they are saved. Your supervisor receives a notification.", es: "Los días por enfermedad se aplican al guardarse. Tu supervisor recibe una notificación." },
  "timeOff.approvalHelp": { en: "Your supervisor must approve these dates before you are taken off the schedule.", es: "Tu supervisor debe aprobar estas fechas antes de quitarte del horario." },
  "timeOff.report": { en: "Report sick day(s)", es: "Reportar enfermedad" },
  "timeOff.submit": { en: "Request time off", es: "Solicitar días libres" },
  "timeOff.saving": { en: "Saving…", es: "Guardando…" },
  "timeOff.sickSaved": { en: "Sick days recorded. Your supervisor’s notification is queued for delivery.", es: "Días por enfermedad registrados. La notificación a tu supervisor está en cola." },
  "timeOff.requestSaved": { en: "Request saved. Waiting for supervisor approval.", es: "Solicitud guardada. Esperando aprobación del supervisor." },
  "timeOff.pending": { en: "Requests to review", es: "Solicitudes por revisar" },
  "timeOff.person": { en: "Crew member", es: "Miembro del equipo" },
  "timeOff.approve": { en: "Approve", es: "Aprobar" },
  "timeOff.decline": { en: "Decline", es: "Rechazar" },
  "timeOff.counts": { en: "Day counts", es: "Conteo de días" },
  "timeOff.month": { en: "Month", es: "Mes" },
  "timeOff.year": { en: "Year", es: "Año" },
  "timeOff.all": { en: "All time", es: "Todo el tiempo" },
  "timeOff.countHelp": { en: "Recorded days through today. Approved future days appear below each count; pending requests are excluded.", es: "Días registrados hasta hoy. Los días futuros aprobados aparecen debajo de cada total; las solicitudes pendientes no cuentan." },
  "timeOff.planned": { en: "{n} future days approved", es: "{n} días futuros aprobados" },
  "timeOff.history": { en: "Requests & history", es: "Solicitudes e historial" },
  "timeOff.empty": { en: "No time off recorded yet.", es: "Aún no hay días libres registrados." },
  "timeOff.status.approved": { en: "Recorded / approved", es: "Registrado / aprobado" },
  "timeOff.status.pending": { en: "Awaiting approval", es: "Esperando aprobación" },
  "timeOff.status.declined": { en: "Declined", es: "Rechazado" },
  "timeOff.status.canceled": { en: "Canceled", es: "Cancelado" },
  "timeOff.cancel": { en: "Cancel entry", es: "Cancelar registro" },
  "timeOff.details": { en: "View requests and day counts", es: "Ver solicitudes y conteos" },
  "lunch.hint": { en: "Lunch reminder after 30 minutes. For alerts while Forge is closed, enable notifications in", es: "Recordatorio después de 30 minutos de almuerzo. Para recibir alertas con Forge cerrado, activa notificaciones en" },
  "lunch.settings": { en: "Settings", es: "Configuración" },
  "lunch.title": { en: "Your 30-minute lunch is up", es: "Han pasado 30 minutos de almuerzo" },
  "lunch.body": { en: "Ready to return? End your break to resume your clock.", es: "¿Listo para volver? Termina tu descanso para reanudar el reloj." },
  "lunch.open": { en: "Open my clock", es: "Abrir mi reloj" },
  ...
  "timecard.approveWeek": { en: "Approve week", es: "Aprobar semana" },
  "timecard.weekNeedsCorrection": { en: "Finish or correct open, unfinished, or rejected entries first.", es: "Primero termina o corrige las entradas abiertas, sin terminar o rechazadas." },
  "timecard.weeksPending": { en: "{n} weekly timecards to approve", es: "{n} tarjetas semanales por aprobar" },
  "timecard.weekNeedsApproval": { en: "Week needs approval", es: "La semana necesita aprobación" },
  ...
  "timeexport.title": { en: "Export time entries", es: "Exportar registros de tiempo" },
  "timeexport.customDates": { en: "Export custom dates", es: "Exportar fechas personalizadas" },
  "timeexport.jobsTitle": { en: "Export job timecards", es: "Exportar horas por trabajo" },
  "timeexport.jobsZip": { en: "Separate CSV for each job · ZIP", es: "CSV separado por trabajo · ZIP" },
  "timeexport.fullHistory": { en: "Full job history", es: "Historial completo" },
  "timeexport.fullHistoryHelp": { en: "Every saved date for the selected jobs, including completed jobs. You can also narrow the report to specific employees.", es: "Todas las fechas guardadas de los trabajos seleccionados, incluidos los terminados. También puedes limitar el informe a ciertos empleados." },
  "timeexport.jobHelp": { en: "Export everyone's recorded time for this job, with custom dates or full history.", es: "Exporta las horas registradas de todos en este trabajo, con fechas personalizadas o el historial completo." },
  "timeexport.billingTitle": { en: "Job complete · Review billing", es: "Trabajo terminado · Revisar facturación" },
  "timeexport.billingHelp": { en: "Review the final charges and export this job's timecards to attach to your invoice or job costing records.", es: "Revisa los cargos finales y exporta las horas de este trabajo para adjuntarlas a la factura o al registro de costos." },
  "timeexport.completedToast": { en: "Job finished and saved in Job history. Next: review billing and export the job's timecards.", es: "Trabajo terminado y guardado en el historial. Siguiente paso: revisar la facturación y exportar sus horas." },
  "timeexport.allPeople": { en: "All employees", es: "Todos los empleados" },
  ...
  "timeexport.popupBlocked": { en: "Allow a new tab for Forge to open the printable report.", es: "Permite abrir una pestaña nueva para ver el informe imprimible de Forge." },
  "timeexport.importedJob": { en: "STG job awaiting assignment: {job}", es: "Trabajo STG pendiente de asignación: {job}" },
  ...
  "timecard.descriptionLabel": { en: "Day / project description (optional)", es: "Descripción del día / proyecto (opcional)" },
  "timecard.descriptionPlaceholder": { en: "What did you work on? Add progress, delays, or other details about this job.", es: "¿En qué trabajaste? Añade avances, retrasos u otros detalles de este trabajo." },
  "timecard.descriptionHelp": { en: "Saved with this job entry. If you worked on several jobs, add details to each entry.", es: "Se guarda con esta entrada de trabajo. Si trabajaste en varios proyectos, añade detalles a cada entrada." },
  ...
  "ask.report.running": { en: "Running", es: "En curso" },
  "ask.report.unassigned": { en: "Unassigned in scope", es: "Sin obra en este informe" },
  "ask.report.projected": { en: "Projected", es: "Estimadas" },
  "ask.report.goal": { en: "Goal", es: "Meta" },
  "ask.report.stages": { en: "stages marked complete", es: "etapas completadas" },
  "ask.report.recentLogs": { en: "Recent daily logs", es: "Informes diarios recientes" },
  "ask.report.openJob": { en: "Open job", es: "Abrir obra" },
  "ask.report.snapshot": { en: "Snapshot:", es: "Datos al:" },
  "ask.report.self": { en: "Your time", es: "Tus horas" },
  "ask.report.team": { en: "Permitted crew time", es: "Horas del equipo autorizado" },
  "ask.report.counts": { en: "People: {people} · Finished entries: {entries}", es: "{people} personas · {entries} registros terminados" },
  "ask.report.scopePeople": { en: "People:", es: "Personas:" },
  "ask.report.scopeJobs": { en: "Jobs:", es: "Obras:" },
  "ask.report.allPeople": { en: "All permitted crew", es: "Todo el equipo autorizado" },
  "ask.report.allJobs": { en: "All jobs, including unassigned time", es: "Todas las obras, incluyendo horas sin asignar" },
  "ask.report.noRows": { en: "Selected records; no hours", es: "Registros seleccionados; sin horas" },
  "ask.report.review": { en: "Needs review: {unresolved} unresolved · {unapproved} unapproved · {suspect} suspect timestamps", es: "Revisar: {unresolved} sin resolver · {unapproved} sin aprobar · {suspect} horarios sospechosos" },
  "ask.report.breakdown": { en: "Recorded hours breakdown", es: "Desglose de horas registradas" },
  "ask.report.exportHelp": { en: "Downloads contain finished shifts only, from this exact snapshot. Dates follow clock-in day. This is not payroll approval or an overtime calculation.", es: "Las descargas incluyen solo turnos terminados de estos datos. Las fechas corresponden al día de entrada. Esto no aprueba nómina ni calcula horas extras." },
  "ask.report.csv": { en: "Download CSV", es: "Descargar CSV" },
  "ask.report.pdf": { en: "Download PDF", es: "Descargar PDF" },
  "ask.report.preparing": { en: "Preparing…", es: "Preparando…" },
  "ask.report.exportError": { en: "Could not create the file. Your report is still here; try again.", es: "No se pudo crear el archivo. El informe sigue aquí; intenta de nuevo." },
  "ask.report.cloudError": { en: "The live assistant could not complete that request. No complete report is available yet. Please try again.", es: "El asistente no pudo completar la solicitud. Aún no hay un informe completo. Intenta de nuevo." },
  "ask.report.offline": { en: "Connect to the internet to prepare a complete hours report or job summary. Cached records may be incomplete.", es: "Conéctate a internet para preparar un informe completo de horas o de obra. Los datos guardados pueden estar incompletos." },
  ...
  "workflow.changes": { en: "Changes since the last publication", es: "Cambios desde la última publicación" },
  "workflow.purgedHelp": { en: "This job was permanently deleted. The plan is retained as history; pending notifications are no longer sent.", es: "Este trabajo se eliminó permanentemente. El plan se conserva como historial; ya no se envían las notificaciones pendientes." },
  "workflow.review": { en: "Review plan", es: "Revisar plan" },
  "workflow.loading": { en: "Loading plan…", es: "Cargando plan…" },
  "workflow.close": { en: "Close", es: "Cerrar" },
  "workflow.revision": { en: "Version {n}", es: "Versión {n}" },
  "workflow.canceled": { en: "Canceled", es: "Cancelado" },
  "workflow.draft": { en: "Unpublished changes", es: "Cambios sin publicar" },
  "workflow.published": { en: "Published", es: "Publicado" },
  "workflow.draftHelp": { en: "Saved changes stay private until you publish. Crew keeps the last published instructions.", es: "Los cambios guardados son privados hasta que los publiques. El equipo sigue viendo las últimas instrucciones publicadas." },
  "workflow.publishedNotice": { en: "Plan updated. Check notification delivery below.", es: "Plan actualizado. Revisa la entrega de notificaciones abajo." },
  "workflow.noticesPending": { en: "Plan updated. Notifications are still pending; retry delivery below.", es: "Plan actualizado. Las notificaciones siguen pendientes; vuelve a intentar enviarlas abajo." },
  "workflow.crew": { en: "Crew", es: "Equipo" },
  "workflow.workBlock": { en: "Work block {n}", es: "Bloque de trabajo {n}" },
  "workflow.start": { en: "Work start date", es: "Inicio del trabajo" },
  "workflow.end": { en: "Work end date", es: "Fin del trabajo" },
  "workflow.startTime": { en: "Work start time", es: "Hora de inicio del trabajo" },
  "workflow.notes": { en: "Notes", es: "Notas" },
  "workflow.vehicleCount": { en: "{n} vehicle bookings follow these work dates", es: "{n} reservas de vehículos siguen estas fechas de trabajo" },
  "workflow.vehicle": { en: "Vehicle", es: "Vehículo" },
  "workflow.trip": { en: "Trip", es: "Viaje" },
  "workflow.name": { en: "Name", es: "Nombre" },
  "workflow.destination": { en: "Destination", es: "Destino" },
  "workflow.travelStart": { en: "Travel start date", es: "Inicio del viaje" },
  "workflow.travelEnd": { en: "Travel end date", es: "Fin del viaje" },
  "workflow.timezone": { en: "Trip time zone", es: "Zona horaria del viaje" },
  "workflow.travelDetails": { en: "Review flights, lodging, instructions and files", es: "Revisar vuelos, alojamiento, instrucciones y archivos" },
  "workflow.detailsReadOnly": { en: "Complete flights, lodging, transport and files in Travel before connecting. These details become read-only in this version. You can disconnect a plan before its first publication to edit them.", es: "Completa los vuelos, el alojamiento, el transporte y los archivos en Viajes antes de conectar. En esta versión esos detalles quedan como solo lectura. Puedes desconectar un plan antes de su primera publicación para editarlos." },
  "workflow.conflictCount": { en: "{n} booking conflicts to review", es: "{n} conflictos de reservas para revisar" },
  "workflow.vehicleConflict": { en: "A vehicle is double-booked. Change the work dates or resolve the other booking before publishing.", es: "Un vehículo tiene reservas que se superponen. Cambia las fechas de trabajo o resuelve la otra reserva antes de publicar." },
  "workflow.allowConflicts": { en: "I reviewed and accept these crew overlaps.", es: "Revisé y acepto estas superposiciones del equipo." },
  "workflow.noticeState": { en: "Notifications: {sent} sent · {pending} pending or failed", es: "Notificaciones: {sent} enviadas · {pending} pendientes o fallidas" },
  "workflow.save": { en: "Save working draft", es: "Guardar borrador" },
  "workflow.publish": { en: "Publish this plan", es: "Publicar este plan" },
  "workflow.retryAction": { en: "Retry the same action", es: "Reintentar la misma acción" },
  "workflow.reload": { en: "Reload latest plan", es: "Cargar el plan más reciente" },
  "workflow.discardEdits": { en: "Discard your unsaved edits?", es: "¿Descartar los cambios sin guardar?" },
  "workflow.saved": { en: "Draft saved. Review it before publishing.", es: "Borrador guardado. Revísalo antes de publicar." },
  ...
  "workflow.connectHelp": { en: "Connect selected work blocks and trips for one job. Review and publish them together.", es: "Conecta bloques de trabajo y viajes seleccionados para un trabajo. Revísalos y publícalos juntos." },
  "workflow.connect": { en: "Connect a plan", es: "Conectar un plan" },
  "workflow.job": { en: "Job", es: "Trabajo" },
  "workflow.chooseJob": { en: "Choose a job", es: "Elige un trabajo" },
  "workflow.chooseWork": { en: "Select unpublished work blocks", es: "Selecciona bloques de trabajo sin publicar" },
  "workflow.chooseTrips": { en: "Select unpublished trips", es: "Selecciona viajes sin publicar" },
  "workflow.crewCount": { en: "{n} crew members", es: "{n} integrantes del equipo" },
