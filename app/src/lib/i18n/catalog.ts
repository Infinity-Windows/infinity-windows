...
export const CATALOG = {
  ...
  "dictation.offline": { en: "Connect to the internet to dictate, or use your keyboard’s microphone.", es: "Conéctate a internet para dictar, o usa el micrófono del teclado." },
