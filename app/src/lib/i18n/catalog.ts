...
export const CATALOG = {
  ...
  "ask.action.job": { en: "Review new job", es: "Revisar trabajo nuevo" },
  "ask.action.schedule": { en: "Review crew schedule", es: "Revisar horario del equipo" },
  "ask.action.unverified": { en: "The result could not be verified. Retry the same card.", es: "No se pudo verificar el resultado. Reintenta con esta tarjeta." },
  "ask.action.saved": { en: "Job created.", es: "Trabajo creado." },
  "ask.action.similar": { en: "Similar jobs \u2014 check before creating another", es: "Trabajos similares — revisa antes de crear otro" },
  "ask.action.notReady": { en: "This creates a job marked Not ready, with both warehouse staging bays. Confirm readiness on the job before scheduling installation.", es: "Esto crea un trabajo No listo con sus dos áreas de almacén. Confirma que esté listo antes de programar la instalación." },
  "ask.action.create": { en: "Create job", es: "Crear trabajo" },
  "ask.action.draftCount": { en: "{n} crew assignments saved as drafts.", es: "{n} asignaciones guardadas como borradores." },
  "ask.action.reviewHelp": { en: "Review people, dates and availability. Publishing updates My Schedule and queues a notification to each assigned person. Travel remains separate.", es: "Revisa personas, fechas y disponibilidad. Publicar actualiza Mi horario y pone en cola una notificación para cada persona. Los viajes se manejan por separado." },
  "ask.action.published": { en: "Schedule published. Crew notifications are queued.", es: "Horario publicado. Las notificaciones están en cola." },
  "ask.action.review": { en: "Review / refresh availability", es: "Revisar / actualizar disponibilidad" },
  "ask.action.publish": { en: "Publish this schedule", es: "Publicar este horario" },
  "ask.action.openSchedule": { en: "Open Scheduling to edit or remove drafts", es: "Abrir Horarios para editar o eliminar borradores" },
  "ask.action.field.address": { en: "Address", es: "Dirección" },
  "ask.action.field.customerName": { en: "Customer", es: "Cliente" },
  "ask.action.field.contactPhone": { en: "Contact phone", es: "Teléfono" },
  "ask.action.field.contactEmail": { en: "Contact email", es: "Correo" },
  "ask.action.field.notes": { en: "Scope / notes", es: "Alcance / notas" },
  "ask.action.field.startDate": { en: "Planned start", es: "Inicio previsto" },
  "ask.action.field.endDate": { en: "Planned finish", es: "Fin previsto" },
  "ask.action.field.projectedHours": { en: "Projected hours", es: "Horas previstas" },
  "ask.action.field.goalHours": { en: "Goal hours", es: "Meta de horas" },
  "ask.action.field.squareFeet": { en: "Square feet", es: "Pies cuadrados" },
  ...
  "ask.greeting": {
    en: "Ask for hours reports, exports, job summaries, new jobs, or help scheduling a crew. Live requests follow your access and need a connection. Installation notes still work offline.",
  ...
  "ask.inputPlaceholder": { en: "Ask about hours, jobs, schedules, or installation…", es: "Pregunta sobre horas, obras, horarios o instalación…" },
