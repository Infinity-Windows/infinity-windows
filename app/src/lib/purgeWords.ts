...
export const WORK_HISTORY_PROBES: readonly HistoryProbe[] = [
  { table: "ai_field_requests", column: "profile_id", one: "Forge AI field message", many: "Forge AI field messages" },
  { table: "ai_field_actions", column: "profile_id", one: "Forge AI field action", many: "Forge AI field actions" },
  { table: "daily_log_contributions", column: "actor_id", one: "daily log entry", many: "daily log entries" },
  ...
  { table: "hex_learning_reviews", column: "author_id", one: "lesson write-up", many: "lesson write-ups" },
  { table: "hex_learning_reviews", column: "reviewer_id", one: "write-up sent to them for review", many: "write-ups sent to them for review" },
  { table: "hex_learning_reviews", column: "decided_by", one: "write-up review decision", many: "write-up review decisions" },
  { table: "hex_learning_review_events", column: "actor_id", one: "write-up history entry", many: "write-up history entries" },
  { table: "hex_learning_reviews", column: "withdrawn_by", one: "lesson withdrawal", many: "lesson withdrawals" },
  { table: "hex_learning_deliveries", column: "last_caller", one: "lesson delivery attempt", many: "lesson delivery attempts" },
  { table: "hex_learning_withdrawals", column: "last_caller", one: "lesson removal attempt", many: "lesson removal attempts" },
  ...
  { table: "time_off_requests", column: "profile_id", one: "time-off entry", many: "time-off entries" },
  { table: "crew_reminders", column: "profile_id", one: "reminder", many: "reminders" },
  { table: "service_visits", column: "created_by", one: "service record", many: "service records" },
  { table: "service_visit_units", column: "created_by", one: "service record", many: "service records" },
  { table: "service_time_sessions", column: "profile_id", one: "service record", many: "service records" },
  { table: "service_media", column: "created_by", one: "service record", many: "service records" },
  { table: "service_audit", column: "actor_id", one: "service record", many: "service records" },
  { table: "service_commands", column: "profile_id", one: "service record", many: "service records" },

  { table: "custom_work_units", column: "created_by", one: "custom work record", many: "custom work records" },
  { table: "custom_work_sessions", column: "profile_id", one: "custom work record", many: "custom work records" },
