...
import { findInWarehouse, type FindAnswer, type PackageHit } from "../../lib/warehouse/find";
...
export function FindBar({
  ...
  const answer = useMemo(
    () => findInWarehouse(query, { packages, containers, projects, scheduledMarks }),
    [query, packages, containers, projects, scheduledMarks],
  );
  ...
  return (
    <div className="wh-find">
      <div className="locate-search">
        <input
          placeholder="Find: window 16, PKG-000123, Conex 3, BLACK22…"
          value={query}
