...
export function Diagnostics() {
  ...
  const { counts, held, unknown } = useOutbox();
  ...
  // Saved before an update, naming no one: never sent as anyone.
  if (unknown > 0) queues.push({ label: t("diag.unknownOwnerQueue"), pending: unknown, failed: 0 });
