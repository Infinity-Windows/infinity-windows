...
class TestSchemaParsing(unittest.TestCase):
    ...
    def test_recovers_the_expected_tables(self):
        # 73 tables declared by the migrations: 67, plus the five AI spend
        # meters, plus `crew_invites`. Production reported one more base table
        # than the migrations declare; the extra is `project_marks`, which no
        # migration declares.
        self.assertEqual(len(SCHEMA.tables), 73)
