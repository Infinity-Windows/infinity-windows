-- Apply in Supabase → SQL → New query (safe to re-run).
-- Creates project_plan_outlines so the Manual Plan Editor can save footprints.
...
-- CAD-lite features: divider lines + wall window/door openings.
alter table project_plan_outlines
